                    ...
                    <div class="tableRolavel" style="height: auto !important;">
                        <form method="POST">
                            ...
                            <?php {
                                ...
                                $cel = intval(preg_replace("/[^0-9]/", "", $info['celular']));
                                if ($fone == 0) {
                                    $fone = "";
                                }
                                if ($cel == 0) {
                            ...
                            <div class="form-inline">
                                ...
                                <input type="tel" class="form-control" name="fone" data-mask="<?php echo (strlen($fone) < 11) ? "(00) 0000-0000" : "(00) 0.0000-0000"; ?>" placeholder="Telefone" style="width:31%;" value="<?php echo $fone ?? ""; ?>">&nbsp;&nbsp;&nbsp;
                                <input type="tel" class="form-control" name="celular" data-mask="(00) 0.0000-0000" placeholder="Celular" style="width:31%;" value="<?php echo $cel ?? ""; ?>">&nbsp;&nbsp;&nbsp;
                            </div>
                            ...
                            <div>
                                <div class="form-group float-left">
                                    ...
                                    <a href="<?php echo BASE_URL . "fornecedores" ?>" class="btn btn-danger btn-lg">Cancelar</a>
                                </div>
                                <div class="float-right">
                                <a href="<?php echo BASE_URL . "fornecedores/del/" . $info['Id'] ?>" onclick="return confirm('Deseja Realmente Exluir?');" class="btn btn-danger btn-lg">Excluir</a>
                                </div>
                            </div>
                        </form>
                    </div>
