                    ...
                    <div class="tableRolavel" style="height: auto !important;">
                        <form method="POST">
                            ...
                            <div class="form-inline">
                                ...
                                <input type="tel" class="form-control" name="fone" placeholder="Telefone" style="width:31%;">&nbsp;&nbsp;&nbsp;
                                <input type="tel" class="form-control" name="celular" placeholder="Celular" style="width:31%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            </div>
