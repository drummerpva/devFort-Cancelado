                    ...
                    <div class="tableRolavel" style="height: auto !important;">
                        <form method="POST">
                            ...
                            <div class="form-inline">
                                ...
                                <input type="tel" class="form-control" name="fone" placeholder="Telefone" style="width:38%;">&nbsp;&nbsp;&nbsp;
                                <input type="text" class="form-control" name="comissao" maxlength="5" placeholder="Comissão" style="width:24%;" >&nbsp;&nbsp;&nbsp;
                            </div>
