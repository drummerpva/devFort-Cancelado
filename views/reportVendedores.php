                ...
                <div class="card-body">
                    ...
                    <div class="col-sm-6 float-left">
                        <div class="card">
                            ...
                            <div class="card-body text-center">
                                <form target="_blank" action="<?php echo BASE_URL."report/printVendedores";?>" method="POST">
                    ...
                    <div class="col-sm-6 float-left">
                        <div class="card">
                            ...
                            <div class="card-body text-center">
                                <button class="btn btn-success btn-lg" onclick=" window.open(BASE_URL+'report/printVendedores');">Todos os Vendedores</button>
                            </div>
                        </div>
                    </div>
