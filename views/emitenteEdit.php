                    ...
                    <div class="tableRolavel" style="height: auto !important;">
                        <form method="POST">
                            <div class="form-inline">
                                <input type="text" class="form-control" name="nome" required placeholder="Razão Social" style="width:70%;" value="<?php echo $info['razao_social'] ?? ""; ?>">&nbsp;&nbsp;&nbsp;
                            ...
                            <div class="form-inline">
                            <input type="text" class="form-control" name="fantasia" required placeholder="Razão Social" style="width:99%;" value="<?php echo $info['nome_fantasia'] ?? ""; ?>">&nbsp;&nbsp;&nbsp;
                            </div>
                            <div class="form-inline">
                            ...
                            <div class="form-inline">
                                ...
                                <input type="tel" class="form-control" name="fone" data-mask="<?php echo (strlen($fone) < 11) ? "(00) 0000-0000" : "(00) 0.0000-0000"; ?>" placeholder="Telefone" style="width:24%;" value="<?php echo $fone ?? ""; ?>">&nbsp;&nbsp;&nbsp;
                                <input type="email" class="form-control" name="email" placeholder="Email" style="width:38%;" value="<?php echo $info['email'] ?? ""; ?>">&nbsp;&nbsp;&nbsp;
                            </div>
                            ...
                            <div>
                                ...
                                <a href="<?php echo BASE_URL . "emitentes/del/" . $info['Id'] ?>" onclick="return confirm('Deseja Realmente Exluir?');" class="btn btn-danger btn-lg">Excluir</a>
                                </div>
                            </div>
                        </form>
                    </div>
