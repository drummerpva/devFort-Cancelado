                    ...
                    <div class="tableRolavel" style="height: auto !important;">
                        <form method="POST">
                            ...
                            <div class="form-inline">
                                ...
                                <select name="vendedor" class="form-control"  style="width:38%;">
                                    ...
                                    <?php foreach ($vendedores as $v) {?>
                                        <option value="<?php echo $v['Id']; ?>" <?php echo ($info['id_vendedor'] == $v['Id']) ? "selected" : ""; ?>><?php echo $v['nome']; ?></option>
                                    <?php }?>
                                </select>&nbsp;&nbsp;&nbsp;
                            </div>
                            ...
                            <div>
                                ...
                                <a href="<?php echo BASE_URL . "clientes/del/" . $info['Id'] ?>" onclick="return confirm('Deseja Realmente Exluir?');" class="btn btn-danger btn-lg">Excluir</a>
                                </div>
                            </div>
                        </form>
                    </div>
