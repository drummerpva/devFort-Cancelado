<html>
    <head>
        <title>Relatório de Vendedores do Estado:  <?php echo $uf; ?></title>
    ...
    <body>
        <div class="corpo">
            <h2>Relatório dos Vendedores por Estado</h2>
            ...
            <?php 
                ...
                <div class="items">
                    ...
                    <div>
                        ...
                        <div style="float:left; width: 40%"><b>FONE: </b> <?php echo "(".substr($fone,0,2).") ".substr($fone,2)?></div>
                        <div style="float:left; width: 29%"><b>COMISSÂO: </b> <?php echo number_format($l['comissao'],2,",",".")."%";?></div>
                        <div style="clear:both;"></div>
                    </div>
                    <div>
